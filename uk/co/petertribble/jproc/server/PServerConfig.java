...
/**
 * Hold the configuration of a JProc server.
 *
...
public class PServerConfig {
    ...
    /**
     * Construct a PServerConfig with a specific port.
     *
     * @param port the port number to be used
     */
    public PServerConfig(int port) {
	this.port = port;
    }

    /**
     * Construct a PServerConfig from a configuration file.
     *
     * @param f  the file to be read containing the configuration
     */
    public PServerConfig(File f) {
	if (f.exists()) {
